...
View.prototype.htmlTemplate = function (visor) {
    var htmlContent = $(
        "<div class='jumbotron'><img class='img-thumbnail' id='logoCarmelo' src='img/logo.png'><span class='titulos' id='titulo'>Anuario 2018</span></div>" +
        "<ul class='nav nav-pills botones mb-3' id='pills-tab' role='tablist'>" +
                "<li class='nav-item'>" +
                  "<a class='nav-link active items-menu' id='pillsInicio' data-toggle='pill' href='#' role='tab' aria-controls='pills-home' aria-selected='true'>Inicio</a>" +
                "</li>" +
                "<li class='nav-item'>" +
                  "<a class='nav-link items-menu' id='pillsCompas' data-toggle='pill' href='#' role='tab' aria-controls='pills-profile' aria-selected='false'>Compas</a>" +
                "</li>" +
                "<li class='nav-item'>" +
                  "<a class='nav-link items-menu' id='pillsProfes' data-toggle='pill' href='#' role='tab' aria-controls='pills-contact' aria-selected='false'>Los profes</a>" +
                "</li>" +
                "<li class='nav-item'>" +
                    "<a class='nav-link items-menu' id='pillsCole' data-toggle='pill' href='#' role='tab' aria-controls='pills-contact' aria-selected='false'>El cole</a>" +
                "</li>" +
                "<li class='nav-item'>" +
...
View.prototype.mainStudents = function (visor) {
      ...
      var htmlContent = (
        ...
        "<div  id='visorSecundario' class='row'>" +
            "<div class='col-sm-12'>" + "<center><span class='titulos-textos'>¡Somos la generación 2018!</span></center>"+
                "<span class='textos-varios'>Cada estudiante representa una historia de esfuerzo, de sacrificio, de disciplina.  Cada estudiante a su vez representa la alegría de ver alcanzada una meta en la que han intervenido las voluntades de muchas personas para que el logro de obtener el bachillerato, tenga un significado único para cada uno.<span>" +"<br><br>"+
          "<span class='textos-varios'>De Clic al nombre de cada estudiante para que recuerde un poco de la hstoria que cada estudiante ha querido compartir, así como imágenes que mantendrán viva la presencia de cada uno de ellos en nuestras vidas...</span>" + "</div>" +
        "</div>" +
        "</div>");
        $(visor).html(htmlContent);
   }
...
View.prototype.mainTeachers = function (visor) {
 ...
 View.prototype.listTeachers = function (array, visor) {
    ...
    for (let index = 0; index < array.length; index++) {
        let htmlAlert = $("<div id='"+ index +"' class='alert alert-success alert-profe lista-estudiantes' role='alert'> </div>");
        $(htmlAlert).append(array[index].nombre );
        $(htmlAlert).append(" " + array[index].apellido );
        $(htmlContTmp).append(htmlAlert);
    }
       ...
       " <div class='col-sm-12 container-gallery'>" +
        ...
        "<div class='row'>" +
                    "<div class='col-sm-12 text-center col-thmb'>" +
                        "<img class='img-thmb botones-imgenes img-thmb-sel' src='./"+carpeta+"/pic1.jpg' alt='pic 1'>" +
                        "<img class='img-thmb botones-imgenes' src='./"+carpeta+"/pic2.jpg' alt='pic 2'>" +
                        "<img class='img-thmb botones-imgenes' src='./"+carpeta+"/pic3.jpg' alt='pic 3'>" +
                        "<img class='img-thmb botones-imgenes' src='./"+carpeta+"/pic4.jpg' alt='pic 4'>" +
                        "<img class='img-thmb botones-imgenes' src='./"+carpeta+"/pic5.jpg' alt='pic 5'>" +
                        "<img class='img-thmb botones-imgenes' src='./"+carpeta+"/pic6.jpg' alt='pic 6'>" +
                    "</div>" +
        "</div>" +
"</div>" );
    $(visor).html(htmlString);
